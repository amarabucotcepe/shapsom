...
def gerar_anexos():
    ...
    st.sidebar.divider()
    st.sidebar.markdown("""<h1 style='text-align: center; font-size: 38px;'>Anexos 📄</h1>""", unsafe_allow_html=True, help="Clique no botão abaixo para baixar os relatórios de todos os municípios selecionados")
